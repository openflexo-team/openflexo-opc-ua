 ...
 *
 */
public class TestOPCUAInspectors extends GenericFIBInspectorTestCase {
	...
	public static void main(String[] args) {
		System.out.println(generateInspectorTestCaseClass(((FileResourceImpl) ResourceLocator.locateResource("Inspectors/OPCUA")).getFile(),
				"Inspectors/OPCUA/"));
	}
	...
	@Test
	public void testAbstractSelectOPCNodeInspector() {
		validateFIB("Inspectors/OPCUA/EditionAction/AbstractSelectOPCNode.inspector");
	}

	@Test
	public void testAddOPCNodeInspector() {
		validateFIB("Inspectors/OPCUA/EditionAction/AddOPCNode.inspector");
	}
	...
	@Test
	public void testOPCServerInspector() {
		validateFIB("Inspectors/OPCUA/OPCServer.inspector");
	}
