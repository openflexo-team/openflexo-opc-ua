...
public class TestFMLEditorWithOPCUATA extends OpenflexoFIBTestCase {
	...
	public static void setupClass() {
		instanciateTestServiceManager(OPCUATechnologyAdapter.class);
		initGUI();
	...
	public void loadFMLResource() throws FileNotFoundException, ResourceLoadingCancelledException, FlexoException {
		...
		assertNotNull(vpLib);
		VirtualModel virtualModel = vpLib.getVirtualModel("http://openflexo.org/opc-ua-test/MinimalServer.fml");
	...
	public static void initGUI() {
		gcDelegate = new SwingGraphicalContextDelegate(TestFMLEditorWithOPCUATA.class.getSimpleName());
	}
