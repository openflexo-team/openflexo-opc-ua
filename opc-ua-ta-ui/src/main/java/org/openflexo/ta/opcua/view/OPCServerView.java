...
public class OPCServerView extends JPanel implements SelectionSynchronizedModuleView<OPCServer> {
	...
	public OPCServerView(OPCServer text, FlexoController controller, FlexoPerspective perspective) {
