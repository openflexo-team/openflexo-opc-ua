...
/**
 * This class represent the module view for a {@link OPCServer}<br>
 * 
 * @author sylvain
 * 
 */
@SuppressWarnings("serial")
public class DeprecatedOPCServerView extends JPanel implements SelectionSynchronizedModuleView<OPCServer> {
	...
	public DeprecatedOPCServerView(OPCServer text, FlexoController controller, FlexoPerspective perspective) {
