...
public class OPCUAFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(OPCUAFMLModelFactoryIntegrationTest.class.getPackage().getName());
	...
	public void initializeServiceManager() {
		...
		assertNotNull(taService.getTechnologyAdapter(OPCUATechnologyAdapter.class));
	}
	...
	@Test
	@TestOrder(2)
	public void checkOPCUAFMLTechnologyAdapter() {
		log("checkOPCUAFMLTechnologyAdapter()");

		testVirtualModelModelFactoryWithTechnologyAdapter(
				serviceManager.getTechnologyAdapterService().getTechnologyAdapter(OPCUATechnologyAdapter.class));
	}
