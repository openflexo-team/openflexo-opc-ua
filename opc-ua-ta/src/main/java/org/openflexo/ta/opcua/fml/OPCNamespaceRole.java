...
/**
 * A role which allow to reference a {@link OPCNamespace} in a OPC-UA server
 * 
 * @author sylvain, luka
 *
 */
@ModelEntity
@ImplementationClass(OPCNamespaceRole.NamespaceRoleImpl.class)
@XMLElement
@FML("OPCNamespaceRole")
public interface OPCNamespaceRole extends FlexoRole<OPCNamespace> {

	public static abstract class NamespaceRoleImpl extends FlexoRoleImpl<OPCNamespace> implements OPCNamespaceRole {

		@Override
		public Type getType() {
			return OPCNamespace.class;
		}
