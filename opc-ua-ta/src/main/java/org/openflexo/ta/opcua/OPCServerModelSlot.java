 ...
 *
 * <p>
 * The {@code OPCServerModelSlot} acts as a bridge between OpenFlexo and an OPC UA server, enabling models to interact with real-time data
 * using the <a href="https://github.com/eclipse/milo">Eclipse Milo</a> library.
 * </p>
 *
 * <p>
 * For an overview of the OPC UA integration in OpenFlexo, see {@link org.openflexo.ta.opcua}.
 * </p>
 *
 * <h2>Purpose</h2>
 * <p>
 * In OpenFlexo, a <i>ModelSlot</i> defines how an external data source is accessed within a Virtual Model. The {@code OPCServerModelSlot}
 * provides access to data through an OPC UA server.
 * </p>
 *
 * <h2>OPC UA Integration</h2>
 * <p>
 * Through this ModelSlot, OpenFlexo can:
 * </p>
 * <ul>
 ...
 * <p>
 * The OPC UA server structure is represented as follows:
 * </p>
 * <ul>
 ...
 * <p>
 * The {@code OPCServerModelSlot} enables Flexo Modeling Language (FML) scripts to interact with OPC UA data. It supports:
 * </p>
 * <ul>
 ...
 *
 * <p>
 * For details on how OpenFlexo structures OPC UA data, see {@link org.openflexo.ta.opcua}.
 * </p>
 *
 * @author Sylvain, Luka
 */
