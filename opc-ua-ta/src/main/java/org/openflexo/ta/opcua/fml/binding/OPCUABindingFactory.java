...
package org.openflexo.ta.opcua.fml.binding;
...
/**
 * Defines OPC UA specific types binding path element strategy<br>
 * 
 * @author sylvain
 *
 */
public final class OPCUABindingFactory extends TechnologyAdapterBindingFactory {
